...
var file_hotstuff_proto_hostuff_proto_rawDesc = []byte{
	...
	0x63, 0x6b, 0x48, 0x61, 0x73, 0x68, 0x22, 0x97, 0x01, 0x0a, 0x0b, 0x56, 0x6f, 0x74, 0x65, 0x52,
...
var file_hotstuff_proto_hostuff_proto_depIdxs = []int32{
	...
	0,  // 18: pb.hotstuff.Propose:input_type -> pb.Proposal
	9,  // 19: pb.hotstuff.Vote:input_type -> pb.VoteRequest
	1,  // 20: pb.hotstuff.PreCommit:input_type -> pb.Precommit
	2,  // 21: pb.hotstuff.Commit:input_type -> pb.CommitMsg
	3,  // 22: pb.hotstuff.Decide:input_type -> pb.DecideMsg
	4,  // 23: pb.hotstuff.NewView:input_type -> pb.NewViewMsg
	5,  // 24: pb.hotstuff.Timeout:input_type -> pb.TimeoutMsg
	11, // 25: pb.hotstuff.Propose:output_type -> google.protobuf.Empty
	11, // 26: pb.hotstuff.Vote:output_type -> google.protobuf.Empty
	11, // 27: pb.hotstuff.PreCommit:output_type -> google.protobuf.Empty
	11, // 28: pb.hotstuff.Commit:output_type -> google.protobuf.Empty
	11, // 29: pb.hotstuff.Decide:output_type -> google.protobuf.Empty
	11, // 30: pb.hotstuff.NewView:output_type -> google.protobuf.Empty
	11, // 31: pb.hotstuff.Timeout:output_type -> google.protobuf.Empty
